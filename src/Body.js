...
const Body = () =>{
    ...
    return ListOfRestaurants.length === 0 ? (<Shimmer/>) : (
        ...
        <div className="body-container">
            ...
            <input data-testid= "searchInput" type="text" className=" search-box mx-4 p-[5px] border border-stone-950 rounded-full"  value={SearchBtn} onChange={(e)=>{
                setSearchBtn(e.target.value);
            }}></input>
            <button data-testid= "searchButton" className="p-3 mt-2  hover:bg-cyan-300 text-blue-950 font-bold rounded-full" onClick={()=>{
